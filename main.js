...
getweather.addEventListener('click' , () =>{
   ...
   fetch(`https://api.weatherapi.com/v1/current.json?key=f9f085134d6d4f8492a42628230111&q=${location}&aqi=no`)
...
.then(data => {
    ...
    <img src = ${data.current.condition.icon} class='weathericon'>
      </svg>
      <div class="main">${data.current.temp_c} °C</div>
    ...
    <div class="card2">
      <div class="upper">
        ...
        <div class="air">
          <div class="airtext">Wind<br>${data.current.wind_kph} Kp/h</div>
      ...
      <div class="lower">
        <div class="aqi">
          ...
          <img class = "aqicon" src="https://cdn-icons-png.flaticon.com/512/252/252035.png"  height="20px" width="20px">
          </svg>
          <div class="aqitext">Cloud<br>${data.current.cloud}</div>
        </div>
        ...
        <div class="realfeel">
          ...
          <div class="realfeeltext">Real Feel<br>${data.current.feelslike_c} °C</div>
        </div>
        ...
        <div class="pressure">
          ...
          <div class="pressuretext">Pressure<br>${data.current.pressure_mb} mbar</div>
        </div>
        <div class="card3">
        Healthy
        </div>
